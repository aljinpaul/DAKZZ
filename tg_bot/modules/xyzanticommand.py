...
__help__ = """
ഏതെങ്കിലും കമാൻഡ് (/command) തുടങ്ങുന്ന മെസ്സേജുകൾ ഡിലീറ്റ് ചെയ്യുന്നു. 
- /rmcmd <on/off>: ആരെങ്കിലും @BlueTextBot മെസ്സേജ് അയക്കാൻ ശ്രമിച്ചാൽ അത് ഡിലീറ്റ് ചെയ്യുന്നു!
"""

__mod_name__ = "Anti Command"
