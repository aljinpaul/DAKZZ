...
✍️*Bio:* `{usr['bio']}`
➡️*Followers:* `{usr['followers']}`
⬅️*Following:* `{usr['following']}`
🌚*Hireable:* `{usr['hireable']}`
⛵️*Public Repos:* `{usr['public_repos']}`
🚁*Public Gists:* `{usr['public_gists']}`
📨*Email:* `{usr['email']}`
🏢*Company:* `{usr['company']}`
🌍*Website:* `{usr['blog']}`
♻️*Last updated:* `{usr['updated_at']}`
...
__help__ = """
    ...
    - /git:{GitHub username} :ഗിറ്റ്ഹബ്  ഉപയോക്താവിന്റെ വിവരങ്ങൾ നൽകുന്നു.
